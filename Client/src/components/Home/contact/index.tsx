...
const Contact = () => {
  ...
  return (
    <motion.div
      ref={ref}
      className="py-20 flex items-center md:items-start flex-col md:flex-row w-full px-8 md:px-16 lg:px-32 "
      variants={variants}
      initial="initial"
      whileInView="animate"
      viewport={{ once: true }}
    >
      <motion.div className="w-full md:w-1/2 flex flex-col" variants={variants}>
        ...
        <motion.h1
          variants={variants}
          className="mt-2 text-4xl md:text-5xl font-bold font-bask  flex"
        >
          <span>
      ...
      <div className="mt-10 md:mt-0 w-full md:w-1/2 relative">
        ...
        >
          <input
            className="w-full text-lg p-2 rounded-xl mb-3 border  border-black  outline-none"
            type="text"
            placeholder="Name"
            name="name"
            value={data.name}
          ...
          <textarea
            ...
            value={data.message}
            onChange={handleChange}
            className="w-full text-lg p-2 rounded-xl mb-3 border border-secondary placeholder:  outline-none"
          />
          <button
            type="submit"
            className="transition duration-300 hover:bg-[#66DC8D] hover:text-black font-bold px-5 py-3 text-base rounded-xl text-white bg-secondary shadow shadow-black/30"
          >
